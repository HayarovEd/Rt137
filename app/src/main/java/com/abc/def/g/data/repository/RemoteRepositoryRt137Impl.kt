package com.abc.def.g.data.repository

import android.app.Application
import android.content.Context
import com.backendless.Backendless
import com.abc.def.g.data.mapper.mapToGames
import com.abc.def.g.data.remote.RapidApiRt137
import com.abc.def.g.domain.model.GameRt137
import com.abc.def.g.domain.repository.RemoteRepositoryRt137
import com.abc.def.g.domain.utils.ANDROID_API_KEY
import com.abc.def.g.domain.utils.APPLICATION_ID
import com.abc.def.g.domain.utils.BACK_URL
import com.abc.def.g.domain.utils.NAME
import com.abc.def.g.domain.utils.ResourceRt137
import com.abc.def.g.domain.utils.TABLE_NAME
import com.abc.def.g.domain.utils.OBJECT_ID_KEY
import com.abc.def.g.domain.utils.POLITIC_URL
import com.abc.def.g.domain.utils.SHARED_DATA
import com.abc.def.g.domain.utils.SHARED_URL
